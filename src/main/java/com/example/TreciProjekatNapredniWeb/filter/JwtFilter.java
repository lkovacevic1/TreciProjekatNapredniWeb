package com.example.TreciProjekatNapredniWeb.filter;

import com.example.TreciProjekatNapredniWeb.services.UserDetailService;
import com.example.TreciProjekatNapredniWeb.services.UserServiceImplementation;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(username != null && SecurityContextHolder.getContext().getAuthentication() == null){
            ...
            System.out.println("Userdetails je: " + userDetails.getUsername());
